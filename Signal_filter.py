...
def main():
    ...
    with open("index.html", "w", encoding="utf-8") as f:
        ...
        f.write('  <input type="range" min="0" max="100" value="100" id="rsi-slider"><br>\n')
        f.write('  <label>P/E: <span id="pe-value"></span></label>\n')
        f.write('  <input type="range" min="0" max="100" value="100" id="pe-slider"><br>\n')
        f.write('  <label>Market Cap ($B): <span id="cap-value"></span></label>\n')
        f.write('  <input type="range" min="0" max="3000" value="0" id="cap-slider"><br>\n')
